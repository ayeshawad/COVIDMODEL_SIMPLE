...
p.eps_I_M      = 0.11;          % half effect recruitment of monocytes                                  UNKNOWN     
p.MR           = 0.1619*70/5000; 
p.psi_M_max    = 11.5451;
...
p.p_F_MPhi = 1.3;                                                                                    %UNKNOWN
p.eta_F_MPhi = 1e-5;        %                                                              %UNKNOWN
...
p.A_L = p.stoch*p.MM_L/p.avo*(p.R_L_M+p.R_L_N+p.R_L_T)*(1/5000)*10^9*1e12;% IL-6 and 
...
p.A_alpha = p.stoch*p.MM_alpha/p.avo*(p.R_alpha_MPhi+p.R_alpha_K)*(1/5000)*10^9*1e12;% TNF Alpha and p.R_alpha_M
